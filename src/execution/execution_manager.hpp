...
class ExecutionManager {
    ...
    explicit ExecutionManager(const char* host, const char* api_key, const char* api_secret, const ProductTable& products)
    :host_(host), api_key_(api_key), api_secret_(api_secret), products_(products), conn_pool_(host, api_key, api_secret, products) {
